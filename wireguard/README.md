...
$ amnezia-wg -f wg0
```
When an interface is running, you may use [`amnezia-wg-tools `](https://github.com/wwwiretap/amnezia-wg-tools) to configure it, as well as the usual `ip(8)` and `ifconfig(8)` commands.
...
This runs on MacOS, you should use it from [awg-apple](https://github.com/wwwiretap/awg-apple)

### Windows

This runs on Windows, you should use it from [awg-windows](https://github.com/wwwiretap/awg-windows), which uses this as a module.
...
```
$ git clone https://github.com/wwwiretap/amnezia-wg
$ cd amnezia-wg
$ make
```
